        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Link href="/properties?type=residential" className="group">
              <div className="bg-gradient-to-br from-[#011337]/10 to-[#011337]/20 dark:from-[#011337] dark:to-[#011337]/80 p-8 rounded-2xl text-center hover:shadow-xl transition-all duration-300 group-hover:scale-105 border border-[#011337]/20 dark:border-[#011337]/40">
                <div className="bg-gradient-to-br from-[#011337] to-[#011337]/80 p-4 rounded-2xl w-16 h-16 mx-auto mb-4 group-hover:from-[#011337]/80 group-hover:to-[#011337] transition-all">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold mb-2 text-[#011337] dark:text-white">Luxury Villas</h3>
              </div>
            </Link>
            ...
            <Link href="/properties?type=investment" className="group">
              <div className="bg-gradient-to-br from-[#011337]/10 to-[#011337]/20 dark:from-[#011337] dark:to-[#011337]/80 p-8 rounded-2xl text-center hover:shadow-xl transition-all duration-300 group-hover:scale-105 border border-[#011337]/20 dark:border-[#011337]/40">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#011337] dark:text-white">Properties</h3>
              </div>
            </Link>
          </div>
        </div>
