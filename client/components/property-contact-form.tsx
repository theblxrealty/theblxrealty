...
export default function PropertyContactForm({ propertyTitle }: PropertyContactFormProps) {
  ...
  const selectedMonth = months.find(m => m.value === formState.preferredMonth) || months[0]
    ...
    <div className="relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold mb-3" style={{fontFamily: 'Tiempos Headline, serif', fontWeight: '400'}}>Request viewing</h2>
          <p className="text-gray-600 text-sm font-['Suisse_Intl',sans-serif]">
            ...
            One of the team will accompany you to the appointment, so you can ask any other 
              ...
              <div className="mt-2">
                ...
                <div className="flex gap-2 mb-3 flex-wrap">
                  {months.map((month) => (
                    <button
                      ...
                      type="button"
                      onClick={() => {
                        handleSelectChange('preferredMonth', month.value)
                        setCalendarView({ month: month.monthIndex, year: month.year })
                      }}
                      className={`px-4 py-2 rounded text-sm font-['Suisse_Intl',sans-serif] ${
                        formState.preferredMonth === month.value
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm font-['Suisse_Intl',sans-serif]">
                    ...
                    {calendarDates.map((date, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`py-1 text-center font-['Suisse_Intl',sans-serif] rounded ${
                            isCurrentMonth
                              ? isSelected
                                ? 'bg-red-500 text-white'
                                : isToday
